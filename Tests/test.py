...
class Test(AbstractTest):
    ...
    def test_RAM(self) -> None:
        ...
        self.assertEqual(Status.BAD_PARAMS, Solution.addRAM(RAM(1, "DELL", 0)),
                         "BAD_PARAMS > ALREADY_EXISTS")
        # check get func
        ram1 = Solution.getRAMByID(1)
        self.assertEqual(ram1.getRamID(), 1, "Should work")
        self.assertEqual(ram1.getCompany(), "DELL", "Should work")
        self.assertEqual(ram1.getSize(), 10, "Should work")
        # check delete twice
    ...
    def test_File(self) -> None:
        ...
        # check re-enter with delete in between
        self.assertEqual(Status.OK, Solution.addFile(File(5, "MP3", 10)), "Should work")
        self.assertEqual(Status.OK, Solution.deleteFile(File(5, "MP3", 10)), "Should work")
        self.assertEqual(Status.OK, Solution.addFile(File(5, "MP3", 5)), "Re-adding RAM 1")
        # check without tables
        Solution.dropTables()
